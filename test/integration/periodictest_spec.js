...
const path_to_test_periodicjs = path.resolve(__dirname, '../../../test_periodicjs');
const periodic = require(path.join(path_to_test_periodicjs,'app/lib/periodic.js'));
...
const create_server = require(path.join(path_to_test_periodicjs,'test/utility/create_server.js'));
