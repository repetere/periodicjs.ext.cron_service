...
<<<<<<< HEAD
},{"child_process":1,"moment-timezone":7}],3:[function(require,module,exports){
...
},{"./later":5}],5:[function(require,module,exports){
later = function() {
  "use strict";
  var later = {
    version: "1.2.0"
...
=======
},{"child_process":1,"moment-timezone":4}],3:[function(require,module,exports){
>>>>>>> 0558db02a4f91bd27c67f89413aec078d59f3a36
module.exports={
	"version": "2015a",
	"zones": [
...
require("./later");
module.exports = later;
},{"./later":8}],8:[function(require,module,exports){
later = function() {
  "use strict";
  var later = {
    version: "1.2.0"
...
<<<<<<< HEAD
},{"later":4,"moment":9}],11:[function(require,module,exports){
=======
},{"later":7,"moment":9}],11:[function(require,module,exports){
>>>>>>> 0558db02a4f91bd27c67f89413aec078d59f3a36
...
var cronhelper = require('./pretty_cron_helper');
...
var traps = {
	set: function set(obj, prop, value) {
		var prettyCronDisplay = void 0;
		try {
			var cj = new CronJob(value, function () {
...
var cronstring = new Proxy({
	value: '00 00 * * * *'
}, traps);

var get_cronstring = function get_cronstring() {
	return cronhelper.cron_items.map(function (ci) {
		return elements.cronitems['cron_input_' + ci].value;
	}).join(' ');
};

var update_cron_string = function update_cron_string() {
	cronstring.value = get_cronstring();
};

<<<<<<< HEAD
var auto_update_cron_string = function auto_update_cron_string() {
	cronstring.value = elements.auto_update_croninterval.value;
};

var initElementSelectors = function initElementSelectors() {
	var has_individual_cron_items = false;
	cronhelper.cron_items.forEach(function (ci) {
		var interval_ci_element = $('[name="interval-' + ci + '"]');
...
<<<<<<< HEAD
},{"./pretty_cron_helper":13,"./proxypollfill":14,"cron":2,"es6-promise":3}],13:[function(require,module,exports){
=======
},{"./pretty_cron_helper":13,"./proxypollfill":14,"cron":2,"es6-promise":6}],13:[function(require,module,exports){
>>>>>>> 0558db02a4f91bd27c67f89413aec078d59f3a36
'use strict';
...
exports.get_pretty_cron_display = function (cronstring) {
	var cronstring_element_array = cronstring.split(' ');
	var cronstring_to_use = cronstring_element_array.length === 6 ? cronstring_element_array.slice(1).join(' ') : cronstring;
	var schedule = later.parse.cron(cronstring_to_use);
	var prettyNextCron = new Moment(later.schedule(schedule).next()).calendar();
...
<<<<<<< HEAD
},{"later":4,"moment":9,"prettycron":10}],14:[function(require,module,exports){
=======
},{"later":7,"moment":9,"prettycron":10}],14:[function(require,module,exports){
>>>>>>> 0558db02a4f91bd27c67f89413aec078d59f3a36
(function (global){
/*
